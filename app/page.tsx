		...
		<main className="flex min-h-screen flex-col items-center justify-center p-12 sm:p-8">
			<div className="w-full max-w-2xl space-y-6 text-white">
				...
				<p className="mb-4 pt-6 text-lg sm:text-[19px]">
					Hey there! I&apos;m Krish — a Computer Science student at
					the {" "}
					<a
					...
					, passionate about emerging technologies and
					entrepreneurship.
				</p>
				<p className="mb-6 text-lg sm:text-[19px]">
					I love developing innovative, scalable solutions to
					real-world problems through software projects and pitch/case
					competitions. I&apos;m particularly interested in building
					products that have a positive social impact in the education
				...
				<p className="mb-6 text-lg sm:text-[19px]">
					When I&apos;m not coding, you can usually find me singing
					karaoke, playing tennis, or practicing magic tricks. If
					you&apos;d like to connect about potential opportunities or
					even just chat, feel free to reach out anytime at:{" "}
					<a
